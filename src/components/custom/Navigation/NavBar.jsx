            ...
            <nav className="hidden md:flex items-center justify-center flex-1">
              <div className="flex items-center bg-gray-50/80 rounded-full px-2 py-1 border border-gray-100/80 shadow-sm">
                ...
                <Link 
                  href="/employers"
                  className={`text-gray-700 hover:text-gray-900 transition-colors font-medium px-5 py-2 rounded-full ${
                    isActive('/employers') ? 'bg-white shadow-sm text-gray-900' : 'hover:bg-white/80 hover:shadow-sm'
                  }`}
                >
                  For Employers
                </Link>
                ...
                {user ? (
                  <div className="flex items-center gap-3">
                    ...
                    >
                      ...
                      <span className="absolute top-0 right-0 w-2 h-2 bg-gray-900 rounded-full"></span>
                    </motion.button>
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                <Link 
                                  ...
                                  onClick={() => setMobileMenuOpen(false)}
                                >
                                  <Briefcase className="w-5 h-5 mb-1 text-gray-500 group-hover:text-gray-700 transition-colors" />
                                  <span>All Jobs</span>
                                </Link>
                                <Link 
                                  href="/jobs?type=remote" 
                                  ...
                                  onClick={() => setMobileMenuOpen(false)}
                                >
                                  <MapPin className="w-5 h-5 mb-1 text-gray-500 group-hover:text-gray-700 transition-colors" />
                                  <span>Remote</span>
                                </Link>
                                <Link 
                                  ...
                                  onClick={() => setMobileMenuOpen(false)}
                                >
                                  <svg className="w-5 h-5 mb-1 text-gray-500 group-hover:text-gray-700 transition-colors" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
