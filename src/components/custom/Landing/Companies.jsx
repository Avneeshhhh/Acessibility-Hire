    ...
    <section className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-14 md:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-5 text-sm font-bold text-gray-900 rounded-full border border-gray-200 bg-white">
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6 text-gray-900">
            Inclusive <span className="text-gray-800">Employers</span> Trust Us
          </h2>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="relative overflow-hidden bg-white/80 backdrop-blur-sm rounded-xl shadow-md border border-gray-200 p-8 md:p-10">
            ...
            <div className="mt-12 text-center">
              ...
              <Link href="/employers">
                <button className="py-3 px-7 bg-gray-900 hover:bg-black text-white text-base font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200 flex items-center gap-2 mx-auto">
