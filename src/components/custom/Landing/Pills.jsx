    ...
    <section className="py-10 md:py-16 lg:py-20 relative overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-3 sm:px-4 relative z-10 max-w-5xl">
        ...
        <div className="mb-8 md:mb-12 max-w-3xl mx-auto text-center sm:text-left sm:mx-0">
          <div className="w-16 h-2 bg-gray-800 rounded-full mb-4 mx-auto sm:mx-0"></div>
          <span className="text-sm font-bold text-gray-800 uppercase tracking-wider mb-2 block">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
            ...
            <span className="text-gray-800">Hiring Pipelines</span>
          </h2>
                ...
                {metrics.map((metric, index) => (
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      <div className="mb-2 w-8 h-8 md:w-10 md:h-10 rounded-full bg-gray-100 flex items-center justify-center">
                        <metric.icon className="w-4 h-4 md:w-5 md:h-5 text-gray-800" />
                      </div>
